...
}:
{
  ...
  programs.plasma = {
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2025,4,12,19,58,56.481";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "dolphinrc"."Search"."Location" = "Everywhere";
      "kactivitymanagerdrc"."activities"."4c2f2f77-034e-453d-b095-c0c2efd41472" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "4c2f2f77-034e-453d-b095-c0c2efd41472";
      "kcminputrc"."Mouse"."X11LibInputXAccelProfileFlat" = true;
      "kded5rc"."Module-browserintegrationreminder"."autoload" = false;
      "kded5rc"."Module-device_automounter"."autoload" = false;
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "820,655";
      ...
      "kwinrc"."Desktops"."Id_1" = "6a7cb2a4-d4b3-4428-b126-68af4647f79c";
      "kwinrc"."Desktops"."Number" = 1;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/622287e9-0846-534b-b123-573cb62c25c5"."tiles" =
        "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/7672d168-2ff3-5755-8864-62ce0326032c"."tiles" =
        "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/8d2c6ff9-bb84-53f9-a3c3-e06a3252c099"."tiles" =
        "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/a76b4e85-b354-50ed-9c7c-ae9079e76bb2"."tiles" =
        "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/edc514ab-2d99-511a-be14-1596da8ef13e"."tiles" =
        "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
